...
public class OntoCrunchbase {
	public static void main(String[] args) {
		try {
			...
			OWLOntology ontology = manager.loadOntologyFromPhysicalURI((new File("data/ontology/TechOpinions.owl"))
					.toURI());
		...
		// System.out.println("The ontology could not be saved: " +
		// e.getMessage());
		// }
